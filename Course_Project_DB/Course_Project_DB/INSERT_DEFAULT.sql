...
VALUES
	...
	('startstudio', 'whatisit998', 'Star Studio', 40 , 'Belarus, Minsk, Lenina st, 53', NULL),
	('captainrec', 'okoknotok', 'Captain Records Studio', 40 , 'Russia, Moscow, Volgograd pr, 42-5', NULL),
	('sundayye', 'godblessedeveryday', 'Sunday Service', 50 , 'USA, Washington DC, Western Union st, 12', NULL),
	('defjamgoat', 'goatjayz', 'Def Jam Recordings', 60 , 'USA, New York, Machachkala st, 97', NULL),
	('rocafellarecs', 'goatye', 'Roc-A-Fella Records', 60 , 'USA, LA, Bricks st, 42', NULL),
...
VALUES
	...
	('Audio track publishing', NULL, 50, 506),
	('Audio track publishing', NULL, 40, 507),
	('Instrumentals Recording', 8, 280, 508),
	('Consultation', 3, 50, 509),
	('Label subscription', NULL, 100, 509),
	('Album publishing', 2, 750, 509),
	('Consultation', 5, 100, 510),
	('Label subscription', NULL, 300, 510),
